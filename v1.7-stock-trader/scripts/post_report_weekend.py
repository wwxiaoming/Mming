"""
post_report_weekend.py — v1.7.0 周末展望报告
  1. 🌙 美股周五收盘(5 指数 + 7 巨头)
  2. 🎯 周一潜力股 TOP 5(行业+资金+美股+7×24 资讯)
  3. 📰 周末 7×24 资讯摘要(题材归因)
  4. 📈 159941 持仓跟踪
  5. ⚠️ 风险点(周一开盘)
"""
...
from _common import load_json, save_json, DAILY_DIR, log, eastmoney_global_news
...
def section_monday_pick(picks: dict) -> str:
    ...
    out.append("| # | 代码 | 名称 | 现价 | PE | PB | **总分** | 行业 | 估值 | 资金 | 美股 | 资讯 | 5日净流入(亿) | 20日净流入(亿) |")
    out.append("|---|------|------|------|-----|----|----------|------|------|------|------|------|--------------|---------------|")
