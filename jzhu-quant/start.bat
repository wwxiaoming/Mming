...
if defined PS_EXE (
    ...
    if errorlevel 1 (
        ...
        echo        Please run start.bat again and click "Yes" on the UAC prompt.
        echo.
        pause
        exit /b 1
    )
...
echo [Warn] PowerShell not available. Please right-click start.bat and
...
echo.
echo   Once it shows running, run start.bat again.
echo.
echo ============================================
pause
exit /b 1
